            ...
            match current_section {
                ...
                "Stats" => {
                    match key {
                        ...
                        "instantaneous_input_kbps" => stats.instantaneous_input_kbps = value.parse().unwrap_or(0.0),
                        "instantaneous_output_kbps" => stats.instantaneous_output_kbps = value.parse().unwrap_or(0.0),
